...
// Importing EditJobPage(export default) as a lazy loaded component
const EditJobPage = lazy(() => wait(500).then(() => import("./pages/EditJobPage")))

// importing AddJob(named export) as a lazy loaded component
const AddJob = lazy(() => (
  import("./pages/AddJob").then(module => ({default: module.AddJob}))
))
